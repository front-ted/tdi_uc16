  ...
  function layoutLeitor(){
    ...
    HTMLstring+='</div>\n';
    HTMLstring+='<img src="../template/images/logo_senac_colorido.png" id="marcadaguaLogo">\n';
    HTMLstring+='\n';
    ...
    HTMLstring+='</div>\n';
    HTMLstring+='\n';
    HTMLstring+='<script src="../template/js/jquery.min.js"></script>\n';
    HTMLstring+='<script src="../template/js/print.js"></script>\n';
    HTMLstring+='<script src="../template/js/images.loader.js"></script>\n';
